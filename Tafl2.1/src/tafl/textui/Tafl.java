...
public class Tafl {
	...
	public static void main(String[] args) {
		...
		// SI EL TAMAÑO DEL MÉTOD EXCEDE EL MÁXIMO RECOMENDADO SE SUGIERE
		// MOVER FUNCIONALIDAD A NUEVOS MÉTODOS PRIVADOS
		try {
			if (args.length == 0) {
				...
				while (true) {
					...
					if (comprobarSalir(movimiento))
						break; // terminar
					if (comprobarDeshacer(movimiento))
	 ...
	 * @throws CoordenadasIncorrectasException En caso de que la coordenada sea
	 *                                         incorrecta o nula
	 */
	 ...
	 *                                         incorrecta o nula
	 */
	private static boolean comprobarFinalizacionPartida() throws CoordenadasIncorrectasException {
	 ...
	 *                                         incorrecta o nula
	 */
	private static void mostrarGanador() throws CoordenadasIncorrectasException {
