...
/**
 * Comprobación de victoria de atacante rodeando al rey. Aplicable a ambos tipos
 * de juego.
 * 
...
public abstract class ArbitroAbstractoVictoriaAtacanteTest {
	...
	/**
	 * No victoria de atacante rodeando al rey contra el trono. Aplicable a ambos
	 * tipos de juego.
	 */
	@Nested
	...
	class NoVictoriaSiSoloSeRodeaAlReyConUnAtacanteYTrono {
		 ...
		 * 
		 * @throws CoordenadasIncorrectasException si una coordenada está fuera del
		 *                                         tablero
		 */
		@Test
	...
	/**
	 * No victoria de atacante rodeando al rey solo con dos atacantes cuando está en
	 * el trono.
	 */
	@Nested
	...
	class NoVictoriaSiSeRodeaAlReySoloConDosAtacantesCuandoEstaEnElTrono {
		...
		/**
		 * Comprueba que no hay victoria rodeando al rey solo con dos atacantes en
		 * horizontal cuando está situado en el trono.
		 * 
		 * @throws CoordenadasIncorrectasException si una coordenada está fuera del
		 *                                         tablero
		 */
		...
		/**
		 * Comprueba que no hay victoria rodeando al rey solo con dos atacantes en
		 * vertical cuando está situado en el trono.
		 * 
		 * @throws CoordenadasIncorrectasException si una coordenada está fuera del
		 *                                         tablero
		 */
	...
	/**
	 * Victoria de atacante rodeando al rey por las cuatro celdas contiguas cuando
	 * está en el trono.
	 * 
	 * @version 1.0.0.1
	 */
	...
	class VictoriasRodeandoAlReyPorCuatroLadosConCuatroAtacantes {
		...
		/**
		 * Comprueba victoria rodeando al rey en el trono con cuatro atacantes por el
		 * norte.
		 * 
		 * @throws CoordenadasIncorrectasException si hay una coordenada incorrecta
		 * @throws IllegalArgumentException        si los argumentos son incorrectos o
		 *                                         nulos
		 */
		@Test
		...
		void comprobarVictoriaRodeandoAlReyEnElTronoAlNorte()
				throws IllegalArgumentException, CoordenadasIncorrectasException {
	...
	/**
	 * Victoria de atacante rodeando al rey por tres atacantes y el trono cuando
	 * está situado fuera del trono y contiguo al mismo.
	 * 
	 * @version 1.0.0.1
	 */
	@Nested
